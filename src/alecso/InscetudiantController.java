...
public class InscetudiantController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        date.setDayCellFactory(d
                ...
                public void updateItem(LocalDate item, boolean empty) {
                    ...
                    setDisable(item.isAfter(LocalDate.of(2011,01,01)));
                }
            });
    ...
    private void validerajout(ActionEvent event) {
        inscetudiantCrud ic = new inscetudiantCrud();
         int id = fos_user.getIdcnct();
         inscetudiant e ;
         int verif = ic.verif(Idpourajouter);
         if( verif == id)
         {
             JOptionPane.showMessageDialog(null, "Vous etes deja inscrit!");
         }
         else if(!etab.getText().matches("^[a-zA-Z]+$") || ad.getText().matches("^[a-zA-Z]+$") )
         {
        ...
        JOptionPane.showMessageDialog(null, "inscription ajoutée avec succées");
